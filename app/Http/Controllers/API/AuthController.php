...
class AuthController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($record) {
            ...
            if ($user) {
                ...
                return response()->json(['status' => 200, 'user' => $user, 'message' => __('messages.success_register')], 200);
            }
        }
    ...
    public function logins(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            // 'provider' => 'required_without: password',
        ...
        return response()->json(['status' => 400, 'message' => __('messages.invalid_login')], 200);
    }
